...
const STATUS_BY_CODE = {
  ...
  INSPIRATION_DELETE_INVALID: 422,
  ...
  TOOL_CHANGED: 409,
  TOOL_DEPENDENCY_MISSING: 409,
  MODEL_TOOLS_UNAVAILABLE: 409,
  CAPABILITY_CONFLICT: 409,
  REVIEW_CONFLICT: 409,
  MCP_AUTH_REQUIRED: 409,
  MCP_UNAVAILABLE: 409,
  MCP_INCOMPATIBLE: 422,
  PYTHON_UNAVAILABLE: 409,
  TOOL_TIMEOUT: 408,
  TOOL_LIMIT: 422,
  TOOL_FAILED: 502,
  TOOL_OUTCOME_UNKNOWN: 409,
  REVIEW_EXPIRED: 409,
  CAPABILITY_READ_FAILED: 500,
  CAPABILITY_WRITE_FAILED: 500,
  MODEL_RESPONSE_LIMIT: 502,
  MODEL_TIMEOUT: 504,
  EXECUTION_SETTINGS_INVALID: 422,
  EXECUTION_SETTINGS_CONFLICT: 409,
  EXECUTION_SETTINGS_READ_FAILED: 500,
  EXECUTION_SETTINGS_WRITE_FAILED: 500,
  OUTPUT_POLICY_INVALID: 422,
  OUTPUT_POLICY_UNAVAILABLE: 409,
