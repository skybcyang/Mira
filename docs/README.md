...
2026-09-14 局部 UI 打磨已合入本地 `main`（`4222a3c`）：[按钮反馈、运行指示与设置开关验证](validation/2026-09-14-control-feedback.md)。沿用六套外观，主干复验包含键盘、减少动态效果、桌面/390px 和真实 HTTP 运行状态；未推送或替换安装版。
...
最新导航：项目菜单与总览、按项目恢复已打开和常用画板，见[项目打开验证](validation/2026-09-14-project-opening.md)。统一画板搜索、手动关闭与“方法与计划”入口继续保留。
