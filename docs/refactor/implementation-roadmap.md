...
- [x] 1844 项工程回归、类型与两套构建、桌面/390px 浅深色浏览器、原生目录选择/项目切换/草稿保护，以及 arm64 make 和两种 packed smoke；见[验证记录](../validation/2026-09-14-project-opening.md)。测试总数变化来自删除未接入生产路径的桌面策略测试，并新增实际调用链回归。
